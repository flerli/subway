...
- Existing widget modules in scope are `arrival-board`, `weather`, `calendar`, `todo`, and `bulletins`.
...
4. The existing `arrival-board`, `weather`, `calendar`, `todo`, and `bulletins` widgets shall receive an initial four-language translation pass.
...
3. Translate the `arrival-board`, `weather`, `calendar`, `todo`, and `bulletins` widgets into English, German, French, and Spanish.
...
2. Switching the global language updates visible static UI copy for `arrival-board`, `weather`, `calendar`, `todo`, and `bulletins`.
